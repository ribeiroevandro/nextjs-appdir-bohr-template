  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.grid}>
        ...
        <a
          href="https://bohr.io/createRepository?sampleUrl=https://github.com/ribeiroevandro/nextjs-appdir-bohr-template"
          className={styles.card}
          target="_blank"
          rel="noopener noreferrer"
        >
